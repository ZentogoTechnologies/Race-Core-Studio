...
DATOS = Path(__file__).resolve().parents[1] / "data" / "marcas.json"

# Donde viven los logos. Es la carpeta que ya miraba brand_logo_url().
CARPETA_LOGOS = Path(__file__).resolve().parents[1] / "public" / "marcas"
